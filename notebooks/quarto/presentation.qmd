...
## Opportunity Cost of Good Software Dev Practices
...
-   Train a BERT to correctly classifier the AG news dataset
    -   4 classes: Business, Sci/Tech, Sports/World
...
-   **Exact Reproducibility**: `uv.lock` ensures reproducibility.
-   **Linked Dependencies**: Dependency linking prevents identical redundant binaries across environments
...
``` python
# [src/core/schema.py](https://github.com/WillHWThompson/PythonForScientificDevelopment/blob/main/src/core/schema.py)
...
``` python
# [workflow/rules/train.smk](https://github.com/WillHWThompson/PythonForScientificDevelopment/blob/main/workflow/rules/train.smk)
...
``` yaml
# [.github/workflows/ci.yml](https://github.com/WillHWThompson/PythonForScientificDevelopment/blob/main/.github/workflows/ci.yml)
jobs:
  test:
...
``` python
# [src/core/trainer.py](https://github.com/WillHWThompson/PythonForScientificDevelopment/blob/main/src/core/trainer.py)
...
-   **Better Notebooks**: Use python to analyze data, pass results to javascript for interactive plots
-   **One Framework, Many Formats**: Make Websites/Presentations/PDFs and Latex Documents
