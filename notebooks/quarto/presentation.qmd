...
::: {.glass-card .fragment}
### The Automation
-   **Snakemake**: Declarative workflow that tracks results and dependencies.
-   **SLURM Compatible**: Zero-effort submission to the VACC cluster.
-   **Amnesia Proof**: Automatically identifies stale results.
:::

::: {.glass-card .fragment}
### HPC Scaling
-   **VACC Profiles**: Integrated Slurm profiles.
