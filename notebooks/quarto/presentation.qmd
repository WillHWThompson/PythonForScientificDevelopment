...
- **"Solution"**: JSON configs + nested POSIX-compliant shell scripts/Python wrappers.
:::
:::

::: {.column width="50%"}
::: {.glass-card .fragment .fade-up}
### Phase 2: The HPC (VACC)![Alt text](https://i.imgflip.com/ai9uul.jpg)
...
## Bad Scientific Software Development IS A SIN

![You knew how to do ](assets/world_if_meme.jpg){fig-align="center" height="500px"}
...
<!-- 
Make this centered
# Thesis: SLURM is Why We Have Not Cured Cancer  -->
