...
from .schema import NLPModelConfig
...
class BertAdapterClassifier(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # 2. Pass through global adapter
        # This acts as a bottleneck re-representation of the CLS token
        adapted_output = self.adapter(cls_output)
        
        # 3. Residual connection (optional but common in adapters)
